...
public class GrandChainBlock
        extends PillarBlock
        implements Waterloggable {

    public static final MapCodec<GrandChainBlock> CODEC = GrandChainBlock.createCodec(GrandChainBlock::new);
    ...
    public MapCodec<GrandChainBlock> getCodec() {
        return CODEC;
    }

    public GrandChainBlock(Settings settings) {
        super(settings);
